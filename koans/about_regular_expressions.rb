...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Answer: * never fails to match, as it can match zero occurrences.
  end
  ...
  #
  # Why?
  # Answer: They match as much as possible while still allowing the overall pattern to match.
  ...
  # Answer: A character class matches a single character from a set of characters,
  # while alternation allows matching entire patterns as alternatives.
