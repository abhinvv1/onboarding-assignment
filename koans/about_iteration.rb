...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject iterates through the collection, applying the given block to an accumulator value and each element in turn.
    # The initial value of the accumulator is the first argument to inject (or the first element if no initial value is given).
  end
